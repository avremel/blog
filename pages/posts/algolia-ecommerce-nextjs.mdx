...
Algolia provides tools to implement an ecommerce search experience. At its core, it consists of a) search, b) filtering, c) merchandising and d) analytics.
...
<Image className="algolia-range-facet" src="/range_facet.png" alt="Range filter example" />

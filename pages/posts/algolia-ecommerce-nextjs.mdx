...
<aside style={{ background: '#1D1F200D', padding: '10px' }}>
  To understand the mechanics of Lucene based search engines, see <a target="_blank" href="https://www.manning.com/books/relevant-search">Relevant Search</a> and my <a target="_blank" href="https://github.com/avremel/lucene">toy search engine</a>.
</aside>

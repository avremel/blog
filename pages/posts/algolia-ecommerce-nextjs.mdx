...
- Sometimes you want to calculate the UI by taking a look at the data returned by all filters _at the same time_[^1]. The problem is that merging data from a bunch of hooks is [_painful and brittle_](https://github.com/algolia/instantsearch/discussions/5353#discussioncomment-4330951).

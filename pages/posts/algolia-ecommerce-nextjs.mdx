...
export const meta = {
  ...
  description: 'This article is _not_ intended as a comprehensive guide (the docs are superb) but rather notes on how to avoid some footguns/pitfalls.',
  date: 'Aug 2023',
  slug: 'algolia-ecommerce-nextjs',
  ogImage: 'algolia-ecommerce.svg',
}

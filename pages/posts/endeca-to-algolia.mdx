...
- No native support for [Next/Link](https://nextjs.org/docs/api-reference/next/link), see [this long running issue](https://github.com/algolia/instantsearch/issues/5241).
  - _Possible workaround: A new [experimental package](https://www.npmjs.com/package/instantsearch-router-next-experimental) to integrate with NextJS was just released._

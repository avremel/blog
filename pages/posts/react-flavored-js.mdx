...
If you have a hight tolerance for discomfort, jQuery + modern JS might be a mediocre subsitute for React-like frameworks. You will lose the awsome DX (Developer Experience) but only have yourself to blame 😉.

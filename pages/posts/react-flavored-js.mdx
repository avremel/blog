import PaginatorWrapper from '../../components/paginate-bar/wrapper.js'
import StackblitzEmbed from '../../components/stackblitz-embed.jsx'
...
Interactive demo of the paginate component:

<StackblitzEmbed path="https://stackblitz.com/edit/jquery-2mfqsw?embed=1&file=paginate_bar/index.js&theme=dark" />